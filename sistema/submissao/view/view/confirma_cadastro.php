	...
	<div class="container">
		...
		<div class="row">
			<center class="col-md-12 col-xs-12 col-lg-12">
				<h4>Confira aqui se as informa��es est�o corretas e clique em continuar. Caso o contr�rio, clique em voltar para corrigir.</h4>
			</center>
		</div>
		</br>
		...
		<div class="panel panel-default">
			...
			<div class="row">
				<div class="panel-body">
					...
					<div class="row" style="margin-left: 15px"><br/>
						...
						<endereco class="col-md-12 col-xs-12 col-lg-12"><?php echo "<b>Endere�o: </b> " . $endereco; ?></endereco> 
			...
			<div class="row">
				<div class="panel-body">
					<div class="row" style="margin-left: 15px">
						<instituicao class="col-md-12 col-xs-12 col-lg-12"><?php echo "<b>Institui��o:</b> " . $instituicao; ?> </instituicao>
