...
<body>
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12 col-xs-12 col-lg-12">
				<center><h4>Leia com atenção antes de prosseguir</h4></center><br>
				<b>¹A submissão de trabaho é feita em duas etapas, após concluir o cadastro dos dados do trabalho neste formulário clique em confirmar para ser redirecionado para a pagina de envio do PDF.</b><br>
				<b>²Os trabalhos devem ser submetidos no formato PDF e não podem ser publicados em outros formatos como '.doc', '.docx', entre outros.</b><br>
				<b>³Os coautores do trabalho precisam estar previamente cadastrados no sistema, caso contrario não será possível fazer a inclusão do mesmo no trabalho.</b><br>
				<b>O resumo juntamente com o abstract deve possuir no maximo 4.000 caracteres contando espaços, pulo de linhas e outros caracteres.</b>
			</div>
		</div>
		</br>
...
<script type="text/javascript">
		...
		$(document).ready(function(){
            ...
            $(document).on('click','#confirmar_submissao',function(){
                ...
                if(quant > 4000){
                	alert('O resumo juntamente com o abstract deve possuir no maximo 4000 caracteres, contando com os espaços!!!\nO seu possui '+quant+' caracteres');
                	console.log(quant);
                	return;
                }
